...
namespace 项目方案第一版
{
    public partial class 校验结果 : Form
    {
        ...
        {
            Thread th = new Thread(new ThreadStart(xinxichaxun));
            th.Start();
        }
        ...
        private void xinxichaxun()
        {
            Thread th = new Thread(new ThreadStart(jiazaichuangti));
            th.Start();
